...
mixin _$SubcategorySortState {
  ...
  Comparable<dynamic> Function(Subcategory) get getField =>
...
/// @nodoc
abstract class $SubcategorySortStateCopyWith<$Res> {
  factory $SubcategorySortStateCopyWith(SubcategorySortState value,
          $Res Function(SubcategorySortState) then) =
      _$SubcategorySortStateCopyWithImpl<$Res, SubcategorySortState>;
  @useResult
  $Res call(
      {bool sortAscending,
      int sortColumnIndex,
...
class _$SubcategorySortStateCopyWithImpl<$Res,
        $Val extends SubcategorySortState>
    implements $SubcategorySortStateCopyWith<$Res> {
  _$SubcategorySortStateCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$SubcategorySortStateImplCopyWith<$Res>
    implements $SubcategorySortStateCopyWith<$Res> {
  factory _$$SubcategorySortStateImplCopyWith(_$SubcategorySortStateImpl value,
          $Res Function(_$SubcategorySortStateImpl) then) =
      __$$SubcategorySortStateImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {bool sortAscending,
...
/// @nodoc
class __$$SubcategorySortStateImplCopyWithImpl<$Res>
    extends _$SubcategorySortStateCopyWithImpl<$Res, _$SubcategorySortStateImpl>
    implements _$$SubcategorySortStateImplCopyWith<$Res> {
  __$$SubcategorySortStateImplCopyWithImpl(_$SubcategorySortStateImpl _value,
      $Res Function(_$SubcategorySortStateImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$SubcategorySortStateImpl(
      sortAscending: null == sortAscending
          ? _value.sortAscending
          : sortAscending // ignore: cast_nullable_to_non_nullable
              as bool,
...
class _$SubcategorySortStateImpl implements _SubcategorySortState {
  _$SubcategorySortStateImpl(
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$SubcategorySortStateImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$SubcategorySortStateImplCopyWith<_$SubcategorySortStateImpl>
      get copyWith =>
          __$$SubcategorySortStateImplCopyWithImpl<_$SubcategorySortStateImpl>(
              this, _$identity);
}

abstract class _SubcategorySortState implements SubcategorySortState {
  factory _SubcategorySortState(
      {final bool sortAscending,
      final int sortColumnIndex,
      required final Comparable<dynamic> Function(Subcategory) getField,
      final int rowsPerPage}) = _$SubcategorySortStateImpl;
