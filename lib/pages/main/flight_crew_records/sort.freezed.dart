...
/// Adds pattern-matching-related methods to [FlightCrewRecordSortState].
extension FlightCrewRecordSortStatePatterns on FlightCrewRecordSortState {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_FlightCrewRecordSortState value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _FlightCrewRecordSortState() when $default != null:
  ...
  TResult map<TResult extends Object?>(
    ...
    final _that = this;
    switch (_that) {
      case _FlightCrewRecordSortState():
        return $default(_that);
    }
  }
