...
/// Adds pattern-matching-related methods to [ReportSortState].
extension ReportSortStatePatterns on ReportSortState {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ReportSortState value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _ReportSortState() when $default != null:
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(bool sortAscending, int sortColumnIndex,
            Comparable Function(Report report) getField, int rowsPerPage)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
