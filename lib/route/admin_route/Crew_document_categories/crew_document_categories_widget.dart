...
part 'crew_document_categories_data_source.dart';

class CrewDocumentCategoriesDataTable2 extends StatefulWidget {
  const CrewDocumentCategoriesDataTable2({super.key});

  @override
  State<CrewDocumentCategoriesDataTable2> createState() =>
      _CrewDocumentCategoriesDataTable2State();
}

class _CrewDocumentCategoriesDataTable2State
    extends State<CrewDocumentCategoriesDataTable2> {

  final AdminFilter filter = AdminFilter(archived: false);
  bool isInitialize = false;
  late CrewDocumentCategoriesDataSource dataSource =
  ...
  Comparable Function(CrewDocumentCategory category) getField = (category) {
  ...
  Widget builder(BuildContext context, CrewDocumentCategoriesDataSource dataSource) {
