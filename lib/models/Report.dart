...
class Report extends amplify_core.Model {
  ...
  const Report._internal({required this.id, required subject, type, status, required archived, required details, auditor, reportedAt, closer, closeAt, recipients, documents, createdAt, updatedAt}): _subject = subject, _type = type, _status = status, _archived = archived, _details = details, _auditor = auditor, _reportedAt = reportedAt, _closer = closer, _closeAt = closeAt, _recipients = recipients, _documents = documents, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Report({String? id, required String subject, ReportType? type, ReportStatus? status, required bool archived, required String details, Staff? auditor, amplify_core.TemporalDateTime? reportedAt, Staff? closer, amplify_core.TemporalDateTime? closeAt, List<ReportStaff>? recipients, List<ReportDocument>? documents}) {
  ...
  Report copyWith({String? subject, ReportType? type, ReportStatus? status, bool? archived, String? details, Staff? auditor, amplify_core.TemporalDateTime? reportedAt, Staff? closer, amplify_core.TemporalDateTime? closeAt, List<ReportStaff>? recipients, List<ReportDocument>? documents}) {
    return Report._internal(
      id: id,
