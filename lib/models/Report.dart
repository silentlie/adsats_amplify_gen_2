...
class Report extends amplify_core.Model {
  ...
  const Report._internal({required this.id, required subject, type, status, required archived, required details, auditor, reportedAt, required discrepanciesFound, closer, closeAt, recipients, documents, createdAt, updatedAt}): _subject = subject, _type = type, _status = status, _archived = archived, _details = details, _auditor = auditor, _reportedAt = reportedAt, _discrepanciesFound = discrepanciesFound, _closer = closer, _closeAt = closeAt, _recipients = recipients, _documents = documents, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Report({String? id, required String subject, ReportType? type, ReportStatus? status, required bool archived, required String details, Staff? auditor, amplify_core.TemporalDateTime? reportedAt, required bool discrepanciesFound, Staff? closer, amplify_core.TemporalDateTime? closeAt, List<ReportStaff>? recipients, List<ReportDocument>? documents}) {
    return Report._internal(
      ...
      documents: documents != null ? List<ReportDocument>.unmodifiable(documents) : documents);
  }
  ...
  String toString() {
    ...
    buffer.write("auditor=" + (_auditor != null ? _auditor.toString() : "null") + ", ");
    buffer.write("reportedAt=" + (_reportedAt != null ? _reportedAt.format() : "null") + ", ");
    buffer.write("discrepanciesFound=" + (_discrepanciesFound != null ? _discrepanciesFound.toString() : "null") + ", ");
  ...
  Report copyWith({String? subject, ReportType? type, ReportStatus? status, bool? archived, String? details, Staff? auditor, amplify_core.TemporalDateTime? reportedAt, bool? discrepanciesFound, Staff? closer, amplify_core.TemporalDateTime? closeAt, List<ReportStaff>? recipients, List<ReportDocument>? documents}) {
    return Report._internal(
      id: id,
  ...
  Report copyWithModelFieldValues({
    ...
    return Report._internal(
      ...
      discrepanciesFound: discrepanciesFound == null ? this.discrepanciesFound : discrepanciesFound.value,
    ...
    : id = json['id'],
      ...
      _auditor = json['auditor'] != null
        ? json['auditor']['serializedData'] != null
          ? Staff.fromJson(new Map<String, dynamic>.from(json['auditor']['serializedData']))
      ...
      _documents = json['documents']  is Map
        ? (json['documents']['items'] is List
          ? (json['documents']['items'] as List)
              .where((e) => e != null)
              .map((e) => ReportDocument.fromJson(new Map<String, dynamic>.from(e)))
              .toList()
          : null)
        : (json['documents'] is List
          ? (json['documents'] as List)
              .where((e) => e?['serializedData'] != null)
              .map((e) => ReportDocument.fromJson(new Map<String, dynamic>.from(e?['serializedData'])))
              .toList()
          : null),
  ...
  static final DISCREPANCIESFOUND = amplify_core.QueryField(fieldName: "discrepanciesFound");
  ...
  static final DOCUMENTS = amplify_core.QueryField(
    fieldName: "documents",
    fieldType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.model, ofModelName: 'ReportDocument'));
