...
class AircraftNotice extends amplify_core.Model {
  ...
  AircraftNoticeModelIdentifier get modelIdentifier {
      return AircraftNoticeModelIdentifier(
        id: id
      );
  }
  ...
  const AircraftNotice._internal({required this.id, aircraft, notice, createdAt, updatedAt}): _aircraft = aircraft, _notice = notice, _createdAt = createdAt, _updatedAt = updatedAt;
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'aircraft': _aircraft?.toJson(), 'notice': _notice?.toJson(), 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
  ...
  static final amplify_core.QueryModelIdentifier<AircraftNoticeModelIdentifier> MODEL_IDENTIFIER = amplify_core.QueryModelIdentifier<AircraftNoticeModelIdentifier>();
 ...
 */
class AircraftNoticeModelIdentifier implements amplify_core.ModelIdentifier<AircraftNotice> {
  final String id;

  /** Create an instance of AircraftNoticeModelIdentifier using [id] the primary key. */
  const AircraftNoticeModelIdentifier({
    required this.id});
  ...
  bool operator ==(Object other) {
    ...
    return other is AircraftNoticeModelIdentifier &&
      id == other.id;
  }
