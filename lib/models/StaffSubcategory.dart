...
class StaffSubcategory extends amplify_core.Model {
  ...
  StaffSubcategoryModelIdentifier get modelIdentifier {
      return StaffSubcategoryModelIdentifier(
        id: id
      );
  }
  ...
  const StaffSubcategory._internal({required this.id, required accessLevel, subcategory, staff, createdAt, updatedAt}): _accessLevel = accessLevel, _subcategory = subcategory, _staff = staff, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory StaffSubcategory({String? id, required int accessLevel, Subcategory? subcategory, Staff? staff}) {
  ...
  String toString() {
    ...
    buffer.write("id=" + "$id" + ", ");
    buffer.write("accessLevel=" + (_accessLevel != null ? _accessLevel!.toString() : "null") + ", ");
  ...
  StaffSubcategory copyWith({int? accessLevel, Subcategory? subcategory, Staff? staff}) {
    return StaffSubcategory._internal(
      id: id,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'accessLevel': _accessLevel, 'subcategory': _subcategory?.toJson(), 'staff': _staff?.toJson(), 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
  ...
  static final amplify_core.QueryModelIdentifier<StaffSubcategoryModelIdentifier> MODEL_IDENTIFIER = amplify_core.QueryModelIdentifier<StaffSubcategoryModelIdentifier>();
...
class _StaffSubcategoryModelType extends amplify_core.ModelType<StaffSubcategory> {
 ...
 */
class StaffSubcategoryModelIdentifier implements amplify_core.ModelIdentifier<StaffSubcategory> {
  final String id;

  /** Create an instance of StaffSubcategoryModelIdentifier using [id] the primary key. */
  const StaffSubcategoryModelIdentifier({
    required this.id});
  ...
  bool operator ==(Object other) {
    ...
    return other is StaffSubcategoryModelIdentifier &&
      id == other.id;
  }
