...
class Document extends amplify_core.Model {
  ...
  const Document._internal({required this.id, required name, required archived, subcategory, staff, aircraft, expiredAt, issuedAt, createdAt, updatedAt}): _name = name, _archived = archived, _subcategory = subcategory, _staff = staff, _aircraft = aircraft, _expiredAt = expiredAt, _issuedAt = issuedAt, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Document({String? id, required String name, required bool archived, Subcategory? subcategory, Staff? staff, List<AircraftDocument>? aircraft, amplify_core.TemporalDateTime? expiredAt, amplify_core.TemporalDateTime? issuedAt}) {
    return Document._internal(
      ...
      staff: staff,
      aircraft: aircraft != null ? List<AircraftDocument>.unmodifiable(aircraft) : aircraft,
      expiredAt: expiredAt,
      issuedAt: issuedAt);
  }
  ...
  String toString() {
    ...
    buffer.write("subcategory=" + (_subcategory != null ? _subcategory.toString() : "null") + ", ");
  ...
  Document copyWith({String? name, bool? archived, Subcategory? subcategory, Staff? staff, List<AircraftDocument>? aircraft, amplify_core.TemporalDateTime? expiredAt, amplify_core.TemporalDateTime? issuedAt}) {
    return Document._internal(
      id: id,
      name: name ?? this.name,
    ...
    : id = json['id'],
      ...
      _subcategory = json['subcategory'] != null
        ? json['subcategory']['serializedData'] != null
          ? Subcategory.fromJson(new Map<String, dynamic>.from(json['subcategory']['serializedData']))
          : Subcategory.fromJson(new Map<String, dynamic>.from(json['subcategory']))
        : null,
      ...
      _aircraft = json['aircraft']  is Map
        ? (json['aircraft']['items'] is List
          ? (json['aircraft']['items'] as List)
              .where((e) => e != null)
              .map((e) => AircraftDocument.fromJson(new Map<String, dynamic>.from(e)))
              .toList()
          : null)
        : (json['aircraft'] is List
          ? (json['aircraft'] as List)
              .where((e) => e?['serializedData'] != null)
              .map((e) => AircraftDocument.fromJson(new Map<String, dynamic>.from(e?['serializedData'])))
              .toList()
          : null),
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'name': _name, 'archived': _archived, 'subcategory': _subcategory?.toJson(), 'staff': _staff?.toJson(), 'aircraft': _aircraft?.map((AircraftDocument? e) => e?.toJson()).toList(), 'expiredAt': _expiredAt?.format(), 'issuedAt': _issuedAt?.format(), 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
  ...
  static final SUBCATEGORY = amplify_core.QueryField(
    ...
    fieldType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.model, ofModelName: 'Subcategory'));
  ...
  static final AIRCRAFT = amplify_core.QueryField(
    fieldName: "aircraft",
    fieldType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.model, ofModelName: 'AircraftDocument'));
