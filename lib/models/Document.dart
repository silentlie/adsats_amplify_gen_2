...
class Document extends amplify_core.Model {
  ...
  const Document._internal({required this.id, required name, required archived, subcategory, staff, aircraft, createdAt, updatedAt}): _name = name, _archived = archived, _subcategory = subcategory, _staff = staff, _aircraft = aircraft, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Document({String? id, required String name, required bool archived, Subcategory? subcategory, Staff? staff, List<AircraftDocument>? aircraft}) {
  ...
  Document copyWith({String? name, bool? archived, Subcategory? subcategory, Staff? staff, List<AircraftDocument>? aircraft}) {
    return Document._internal(
      id: id,
      name: name ?? this.name,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'name': _name, 'archived': _archived, 'subcategory': _subcategory?.toJson(), 'staff': _staff?.toJson(), 'aircraft': _aircraft?.map((AircraftDocument? e) => e?.toJson()).toList(), 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
