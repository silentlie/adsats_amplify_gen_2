...
class Session extends amplify_core.Model {
  ...
  const Session._internal({required this.id, staff, createdAt, updatedAt}): _staff = staff, _createdAt = createdAt, _updatedAt = updatedAt;
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'staff': _staff?.toJson(), 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
