...
class Role extends amplify_core.Model {
  ...
  factory Role(
      ...
      List<CrewDocumentCategory>? categories}) {
    return Role._internal(
        ...
        categories: categories != null
            ? List<CrewDocumentCategory>.unmodifiable(categories)
            : categories);
  }
        ...
        _categories = json['categories'] is Map
            ? (json['categories']['items'] is List
                ? (json['categories']['items'] as List)
                    .where((e) => e != null)
                    .map((e) => CrewDocumentCategory.fromJson(
  ...
  Map<String, dynamic> toJson() => {
        ...
        'categories':
            _categories?.map((CrewDocumentCategory? e) => e?.toJson()).toList(),
