...
class Role extends amplify_core.Model {
  ...
  final List<CrewDocumentCategory>? _categories;
  ...
  List<CrewDocumentCategory>? get categories {
    return _categories;
  }
  ...
  factory Role({String? id, required String name, required bool archived, String? description, List<RoleStaff>? staff, List<CrewDocumentCategory>? categories}) {
    return Role._internal(
      ...
      categories: categories != null ? List<CrewDocumentCategory>.unmodifiable(categories) : categories);
  }
  ...
  Role copyWith({String? name, bool? archived, String? description, List<RoleStaff>? staff, List<CrewDocumentCategory>? categories}) {
    return Role._internal(
      id: id,
      name: name ?? this.name,
  ...
  Role copyWithModelFieldValues({
    ...
    ModelFieldValue<List<CrewDocumentCategory>?>? categories
  }) {
    return Role._internal(
      id: id,
      ...
      _categories = json['categories']  is Map
        ? (json['categories']['items'] is List
          ? (json['categories']['items'] as List)
              .where((e) => e != null)
              .map((e) => CrewDocumentCategory.fromJson(new Map<String, dynamic>.from(e)))
              .toList()
          : null)
        : (json['categories'] is List
          ? (json['categories'] as List)
              .where((e) => e?['serializedData'] != null)
              .map((e) => CrewDocumentCategory.fromJson(new Map<String, dynamic>.from(e?['serializedData'])))
              .toList()
          : null),
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'name': _name, 'archived': _archived, 'description': _description, 'staff': _staff?.map((RoleStaff? e) => e?.toJson()).toList(), 'categories': _categories?.map((CrewDocumentCategory? e) => e?.toJson()).toList(), 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
  ...
  static var schema = amplify_core.Model.defineSchema(define: (amplify_core.ModelSchemaDefinition modelSchemaDefinition) {
    ...
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.hasMany(
      ...
      associatedKey: CrewDocumentCategory.ROLE
    ));
