...
class RoleStaff extends amplify_core.Model {
  ...
  RoleStaffModelIdentifier get modelIdentifier {
      return RoleStaffModelIdentifier(
        id: id
      );
  }
  ...
  const RoleStaff._internal({required this.id, role, staff, createdAt, updatedAt}): _role = role, _staff = staff, _createdAt = createdAt, _updatedAt = updatedAt;
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'role': _role?.toJson(), 'staff': _staff?.toJson(), 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
  ...
  static final amplify_core.QueryModelIdentifier<RoleStaffModelIdentifier> MODEL_IDENTIFIER = amplify_core.QueryModelIdentifier<RoleStaffModelIdentifier>();
 ...
 */
class RoleStaffModelIdentifier implements amplify_core.ModelIdentifier<RoleStaff> {
  final String id;

  /** Create an instance of RoleStaffModelIdentifier using [id] the primary key. */
  const RoleStaffModelIdentifier({
    required this.id});
  ...
  bool operator ==(Object other) {
    ...
    return other is RoleStaffModelIdentifier &&
      id == other.id;
  }
