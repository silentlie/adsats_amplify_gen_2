...
class AircraftStaff extends amplify_core.Model {
  ...
  AircraftStaffModelIdentifier get modelIdentifier {
      return AircraftStaffModelIdentifier(
        id: id
      );
  }
  ...
  const AircraftStaff._internal({required this.id, aircraft, staff, createdAt, updatedAt}): _aircraft = aircraft, _staff = staff, _createdAt = createdAt, _updatedAt = updatedAt;
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'aircraft': _aircraft?.toJson(), 'staff': _staff?.toJson(), 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
  ...
  static final amplify_core.QueryModelIdentifier<AircraftStaffModelIdentifier> MODEL_IDENTIFIER = amplify_core.QueryModelIdentifier<AircraftStaffModelIdentifier>();
 ...
 */
class AircraftStaffModelIdentifier implements amplify_core.ModelIdentifier<AircraftStaff> {
  final String id;

  /** Create an instance of AircraftStaffModelIdentifier using [id] the primary key. */
  const AircraftStaffModelIdentifier({
    required this.id});
  ...
  bool operator ==(Object other) {
    ...
    return other is AircraftStaffModelIdentifier &&
      id == other.id;
  }
