...
class Category extends amplify_core.Model {
  ...
  const Category._internal({required this.id, required name, required archived, description, subcategories, createdAt, updatedAt}): _name = name, _archived = archived, _description = description, _subcategories = subcategories, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Category({String? id, required String name, required bool archived, String? description, List<Subcategory>? subcategories}) {
    return Category._internal(
      id: id == null ? amplify_core.UUID.getUUID() : id,
      name: name,
      archived: archived,
      description: description,
      subcategories: subcategories != null ? List<Subcategory>.unmodifiable(subcategories) : subcategories);
  }
  ...
  Category copyWith({String? name, bool? archived, String? description, List<Subcategory>? subcategories}) {
    return Category._internal(
      id: id,
      name: name ?? this.name,
      ...
      _subcategories = json['subcategories']  is Map
        ? (json['subcategories']['items'] is List
          ? (json['subcategories']['items'] as List)
              .where((e) => e != null)
              .map((e) => Subcategory.fromJson(new Map<String, dynamic>.from(e)))
              .toList()
          : null)
        : (json['subcategories'] is List
          ? (json['subcategories'] as List)
              .where((e) => e?['serializedData'] != null)
              .map((e) => Subcategory.fromJson(new Map<String, dynamic>.from(e?['serializedData'])))
              .toList()
          : null),
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'name': _name, 'archived': _archived, 'description': _description, 'subcategories': _subcategories?.map((Subcategory? e) => e?.toJson()).toList(), 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
