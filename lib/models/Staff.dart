...
class Staff extends amplify_core.Model {
  ...
  const Staff._internal({required this.id, required name, required email, required archived, documents, notices, notifications, aircraft, roles, subcategories, crewDocuments, reports, reportNotifications, closedReport, createdAt, updatedAt}): _name = name, _email = email, _archived = archived, _documents = documents, _notices = notices, _notifications = notifications, _aircraft = aircraft, _roles = roles, _subcategories = subcategories, _crewDocuments = crewDocuments, _reports = reports, _reportNotifications = reportNotifications, _closedReport = closedReport, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Staff({String? id, required String name, required String email, required bool archived, List<Document>? documents, List<Notice>? notices, List<NoticeStaff>? notifications, List<AircraftStaff>? aircraft, List<RoleStaff>? roles, List<StaffSubcategory>? subcategories, List<CrewDocument>? crewDocuments, List<Report>? reports, List<ReportStaff>? reportNotifications, List<Report>? closedReport}) {
  ...
  Staff copyWith({String? name, String? email, bool? archived, List<Document>? documents, List<Notice>? notices, List<NoticeStaff>? notifications, List<AircraftStaff>? aircraft, List<RoleStaff>? roles, List<StaffSubcategory>? subcategories, List<CrewDocument>? crewDocuments, List<Report>? reports, List<ReportStaff>? reportNotifications, List<Report>? closedReport}) {
    return Staff._internal(
      id: id,
      name: name ?? this.name,
