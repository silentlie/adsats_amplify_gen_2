...
class FlightCrewRecordCategory extends amplify_core.Model {
  ...
  FlightCrewRecordCategoryModelIdentifier get modelIdentifier {
      return FlightCrewRecordCategoryModelIdentifier(
        id: id
      );
  }
  ...
  const FlightCrewRecordCategory._internal({required this.id, required name, required archived, description, role, flightCrewRecords, createdAt, updatedAt}): _name = name, _archived = archived, _description = description, _role = role, _flightCrewRecords = flightCrewRecords, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory FlightCrewRecordCategory({String? id, required String name, required bool archived, String? description, Role? role, List<FlightCrewRecord>? flightCrewRecords}) {
  ...
  FlightCrewRecordCategory copyWith({String? name, bool? archived, String? description, Role? role, List<FlightCrewRecord>? flightCrewRecords}) {
    return FlightCrewRecordCategory._internal(
      id: id,
      name: name ?? this.name,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'name': _name, 'archived': _archived, 'description': _description, 'role': _role?.toJson(), 'flightCrewRecords': _flightCrewRecords?.map((FlightCrewRecord? e) => e?.toJson()).toList(), 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
  ...
  static final amplify_core.QueryModelIdentifier<FlightCrewRecordCategoryModelIdentifier> MODEL_IDENTIFIER = amplify_core.QueryModelIdentifier<FlightCrewRecordCategoryModelIdentifier>();
...
class _FlightCrewRecordCategoryModelType extends amplify_core.ModelType<FlightCrewRecordCategory> {
 ...
 */
class FlightCrewRecordCategoryModelIdentifier implements amplify_core.ModelIdentifier<FlightCrewRecordCategory> {
  final String id;

  /** Create an instance of FlightCrewRecordCategoryModelIdentifier using [id] the primary key. */
  const FlightCrewRecordCategoryModelIdentifier({
    required this.id});
  ...
  bool operator ==(Object other) {
    ...
    return other is FlightCrewRecordCategoryModelIdentifier &&
      id == other.id;
  }
